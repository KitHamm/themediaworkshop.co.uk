...
export async function POST(request: Request) {
    ...
    switch (json.action) {
        ...
        case "submitTicket":
            const isDashboard = json.dashboard === "true" ? true : false;
            const isReproducible = json.reproducible === "true" ? true : false;
            ...
            const reproducible = json.reproducible;

            try {
                const mail = await transporter.sendMail({
                    from: "TMW Website",
                    to: "kit@themediaworkshop.co.uk",
                    replyTo: "kit@themediaworkshop.co.uk",
                    subject: `New Ticket on TMW Website`,
                    html: `
