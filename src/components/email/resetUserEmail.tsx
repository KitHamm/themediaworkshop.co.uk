...
const resetUserTemplate = (password: string) => {
	return `
    <!DOCTYPE html
                                                ...
                                                <tr>
                                                    <td>
                                                        <table style="
                                                            ...
                                                            border-radius: 10px;
                                                        " class="t46" role="presentation" cellpadding="0"
                                                            cellspacing="0" align="center">
                                                            <tr class="t5">
                                                                <!--[if !mso]><!-->
                                                                <td style="
                                                        ...
                                                        <table class="t34" role="presentation" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                ">
                                                                    ...
                                                                    <a class="t41" href="https://themediaworkshop.co.uk/dashboard" style="
                                                                        display: block;
                                                                        margin: 0;
                                                                        margin: 0;
                                                                        font-family: BlinkMacSystemFont,
...
export default resetUserTemplate;
