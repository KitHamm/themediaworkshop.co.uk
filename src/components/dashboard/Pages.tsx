    ...
    return (
        <div className={`${props.hidden ? "hidden" : ""} mx-20`}>
            ...
            <div className="flex justify-evenly">
                <Link
                    className={`${
                        pageEdit === "home" ? "bg-orange-400" : "bg-gray-400"
                ...
                <Link
                    className={`${
                        pageEdit === "film" ? "bg-orange-400" : "bg-gray-400"
                    } w-full text-center mx-4 py-2 rounded`}
                ...
                <Link
                    className={`${
                        pageEdit === "digital" ? "bg-orange-400" : "bg-gray-400"
                    } w-full text-center mx-4 py-2 rounded`}
                ...
                <Link
                    className={`${
                        pageEdit === "light" ? "bg-orange-400" : "bg-gray-400"
                    } w-full text-center mx-4 py-2 rounded`}
                ...
                <Link
                    className={`${
                        pageEdit === "events" ? "bg-orange-400" : "bg-gray-400"
                    } w-full text-center mx-4 py-2 rounded`}
